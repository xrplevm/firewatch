...
describeOrSkip(
    ...
    () => {
        describeOrSkip(
            "v1 (evmos)",
            () => isChainEnvironment([], moduleConfig.network as unknown as Chain),
            () => {
        ...
        describeOrSkip(
            "v2 (cosmos/evm)",
            () => isChainEnvironment(["mainnet", "testnet", "devnet", "localnet"], moduleConfig.network as unknown as Chain),
            () => {
