...
import { XrplSubmitTransactionResponse, XrplTransactionParserProvider } from "../../../../../transaction/parsers/xrp";

export interface XrplXChainSignerProvider extends XrplTransactionParserProvider {
    /**
