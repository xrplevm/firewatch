...
export class FeemarketQueryClient {
    ...
    async params(): Promise<QueryParamsResponse> {
        ...
        const responseData = await this.rpcClient.request("cosmos.evm.feemarket.v1.Query", "Params", requestData) as Uint8Array;
    ...
    async baseFee(): Promise<QueryBaseFeeResponse> {
        ...
        const responseData = await this.rpcClient.request("cosmos.evm.feemarket.v1.Query", "BaseFee", requestData) as Uint8Array;
    ...
    async blockGas(): Promise<QueryBlockGasResponse> {
        ...
        const responseData = await this.rpcClient.request("cosmos.evm.feemarket.v1.Query", "BlockGas", requestData) as Uint8Array;
